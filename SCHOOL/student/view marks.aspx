<%@ Page Title="" Language="C#" MasterPageFile="~/student/student_master.master" AutoEventWireup="true" CodeFile="view marks.aspx.cs" Inherits="student_view_marks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="style3 title" style="font-size:20px"><strong> VIEW MARKS</strong></h1></div>
    <table class="style1">
        <tr>
            <td width="10">
                &nbsp;</td>
         ...
         <tr>
            <td colspan="4">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:schoolConnectionString %>" 
                    SelectCommand="SELECT * FROM [marks] WHERE (([class] = @class) AND ([exam] = @exam))">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList1" Name="class" 
                            PropertyName="SelectedValue" Type="Int32" />
                        <asp:ControlParameter ControlID="DropDownList3" Name="exam" 
